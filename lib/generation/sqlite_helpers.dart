...
///- Return count of records in ${generatorIO.rootFileName}
  ...
  static Future<${generatorIO.rootFileName}> firstRecord({String where, String orderBy = 'rowid asc limit 1'}) async {
    await createTable();
    if (orderBy == null) throw Exception('static first - orderBy string null');
    List<${generatorIO.rootFileName}> results = await readLink(whereClause: where, orderBy: orderBy);
